...
declare function createReactLink({
    router,
    useState,
    useEffect,
    createElement,
...
declare function createReactParamsHook({
    router,
    useState,
    useEffect,
}: {
...
declare function createReactView({
    router,
    createElement,
    useState,
    useEffect,
...
declare function createVueLink({
    router,
    resolveComponent,
    defineComponent,
    h: createElement,
...
declare function createVueParamsHook({
    router,
    ref,
    onMounted,
    onUnmounted,
...
declare function createVueView({
    readonly,
    onMounted,
    onUnmounted,
    router,
...
export {
    ...
    RouteRecord,
    ComponentReactOrVue,
    CustomReactLinkProps,
    DefaultReactLinkProps,
    createReactLink,
    createReactView,
    createReactParamsHook,
    CustomReactViewProps,
    DefaultReactViewProps,
    createVueLink,
    CustomVueLinkProps,
    DefaultVueLinkProps,
    createVueView,
