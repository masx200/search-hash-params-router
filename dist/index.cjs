...
function y(t) {
    if ("string" != typeof t && "symbol" !== c(t))
        throw new TypeError(
            " EVENTNAME expected: string | symbol;but invalid :" + t
        );
}
...
function b(t) {
    if ("function" != typeof t)
        throw new TypeError(
            " EVENTLISTENER expected: (event?: any) => void;but invalid:" + t
        );
}
...
function d() {
    ...
    return (
        f((t = {}), Symbol.toPrimitive, h),
        f(t, Symbol.toStringTag, "EventEmitterTarget"),
        f(t, Symbol.iterator, p),
        f(t, "entries", p),
        f(t, "listenerCount", function (t) {
            return y(t), r.has(t) ? n(t).size : 0;
        }),
        f(t, "clear", o),
        f(t, "removeAllListeners", o),
        f(t, "on", i),
        f(t, "addListener", i),
        f(t, "off", c),
        f(t, "removeListener", c),
        f(t, "once", function (t, r) {
            y(t), b(r);
            var n = !1,
                o = e.get(r);
            o ||
...
var m = (function (t) {
        ...
        function n() {
            var t = d();
            return this && this instanceof n
                ? (Object.assign(this, t), this)
                : Reflect.construct(n, []);
        }
...
var j = function (t) {
    ...
    _ = "object" == e(g) && g && g.Object === Object && g,
    w = _,
    S =
...
var ot = function (t, r, e) {
    ...
    return (
        ...
        Z(e) &&
            ((s = !!e.leading),
            (a = (l = "maxWait" in e) ? et(rt(e.maxWait) || 0, r) : a),
...
function it(t) {
    ...
    if ("function" == typeof t)
        return (
            (n = t(n)), (o.hash = String(new URLSearchParams(r({}, n)))), o.href
        );
    if ("object" === e(t))
        return (
            (n = t), (o.hash = String(new URLSearchParams(r({}, n)))), o.href
        );
...
function ut(t) {
    ...
    (n.hash = String(new URLSearchParams(r({}, t)))),
        e !== n.hash &&
...
function st(t) {
    ...
    if ("function" == typeof t)
        return (
            (n = t(n)),
            (o.search = String(new URLSearchParams(r({}, n)))),
            o.href
        );
    if ("object" === e(t))
        return (
            (n = t), (o.search = String(new URLSearchParams(r({}, n)))), o.href
        );
    throw new TypeError("object,function");
}
...
function lt(t) {
    var e = location.search,
        n = new URL(location.href);
    (n.search = String(new URLSearchParams(r({}, t)))),
        e !== n.search &&
            (history.pushState({}, "", n.href),
...
function vt(t) {
    var e = 0,
        o = "search" === t ? "popstate" : "hashchange",
        a = m(),
        i = ot(function () {
            var r = "hash" === t ? at() : ft();
            c.emit("params", r);
    ...
    var u = n(
            {
                ...
                unmount: function () {
                    --e <= 0 &&
                        ...
                        i.cancel(),
                        c.removeAllListeners("params"));
                },
                gethref: "hash" === t ? it : st,
...
var St = ht,
    Ot = function (t) {
        ...
        return (
            !(e < 0) &&
            (e == r.length - 1 ? r.pop() : gt.call(r, e, 1), --this.size, !0)
        );
    },
    At = function (t) {
        var r = this.__data__,
...
var Ct,
    ...
    Nt = O["__core-js_shared__"],
    Vt = (Ct = /[^.]+$/.exec((Nt && Nt.keys && Nt.keys.IE_PROTO) || ""))
        ? "Symbol(src)_1." + Ct
        : "";
...
var hr = ir,
    ...
    mr = function (t, r) {
        ...
        return (
            ...
            (e[t] = vr && void 0 === r ? "__lodash_hash_undefined__" : r),
            this
        );
    };
...
(Ur.prototype.clear = xr),
    (Ur.prototype.delete = Rr),
    (Ur.prototype.get = kr),
    (Ur.prototype.has = Lr),
    (Ur.prototype.set = zr);
...
!(function (t, r) {
    var e = O,
        ...
        o = r && !r.nodeType && r,
        a = o && t && !t.nodeType && t,
        i = a && a.exports === o ? e.Buffer : void 0,
...
var cn = Ye,
    fn = function (t) {
        ...
        for (var e in Object(t))
            on.call(t, e) && "constructor" != e && r.push(e);
        return r;
    },
    sn = function (t) {
...
((dn && "[object DataView]" != xn(new dn(new ArrayBuffer(1)))) ||
    (mn && "[object Map]" != xn(new mn())) ||
    (gn && "[object Promise]" != xn(gn.resolve())) ||
    (jn && "[object Set]" != xn(new jn())) ||
    (_n && "[object WeakMap]" != xn(new _n()))) &&
    (xn = function (t) {
        var r = wn(t),
...
var Vn = function (t, r, e, n, o, a) {
        var i = Mn(t),
            u = Mn(r),
            c = i ? "[object Array]" : Un(t),
            f = u ? "[object Array]" : Un(r),
            s = (c = "[object Arguments]" == c ? Dn : c) == Dn,
            l = (f = "[object Arguments]" == f ? Dn : f) == Dn,
            p = c == f;
        if (p && In(t)) {
            if (!In(r)) return !1;
            (i = !0), (s = !1);
        ...
        if (p && !s)
            return (
                a || (a = new Rn()),
                i || Cn(t) ? kn(t, r, e, n, o, a) : Ln(t, r, c, e, n, o, a)
            );
        if (!(1 & e)) {
            var v = s && Nn.call(t, "__wrapped__"),
                h = l && Nn.call(r, "__wrapped__");
            if (v || h) {
                var y = v ? t.value() : t,
                    b = h ? r.value() : r;
    ...
    return function (t) {
        if (t) {
            ...
            t.defaultPrevented ||
                ...
                (t.preventDefault(), n.setparams(o));
        } else n.setparams(o);
    };
}
...
var Kn = ["component", "target", "to", "onClick", "innerRef", "children"],
    qn = ["innerRef", "target", "children", "href", "isActive", "navigate"];
...
function Xn(t) {
    return !(
        "function" != typeof (null == t ? void 0 : t.params) ||
        null == t ||
        !t.redirect
    );
}
...
(exports.createHashRouter = function () {
    ...
    (exports.createReactParamsHook = Hn),
    (exports.createReactView = function (t) {
        var e = t.router,
            n = t.createElement,
            o = t.useState,
            a = t.useEffect,
    ...
    (exports.createVueLink = function (t) {
        ...
        return (
            (l.inheritAttrs = !0),
            (l.props = ["innerRef", "target", "href", "isActive", "navigate"]),
            o({
                inheritAttrs: !0,
    ...
    (exports.createVueParamsHook = Zn),
    (exports.createVueView = function (t) {
        var e = t.readonly,
            n = t.onMounted,
            o = t.onUnmounted,
            a = t.router,
